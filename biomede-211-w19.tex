...
\section{Additional Laplace Transform Recourses}
Laplace Transform Explained and Visualized Intuitively-https://youtu.be/6MXMDrs6ZmA
\begin{itemize}
	\item Shows several examples using different Laplace Transforms
	\item Explains the Laplace Transform using 3D visualization
	\item Great soothing background Classical Music
\end{itemize}
Laplace Domain Circuit Analysis-https://youtu.be/L0PZvvt36DA
\begin{itemize}
	\item Elaborates on the RLC chart we created in class
	\item Gives an example using the Laplace Transform to solve a RC circuit
\end{itemize}
