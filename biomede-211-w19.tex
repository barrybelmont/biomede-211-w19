...
\includegraphics[width=0.5\textwidth]{images-BME-211/Node2.JPG}
In the figure above, the nodes are denoted by black dots.

If our lines in a circuit diagram represent wires with zero-resistance conductors, however, the lines do not need to meet in a single point junction. Instead, it can be represented as a distributed node, as shown in the figure below.
\includegraphics[width=0.5\textwidth]{images-BME-211/DistributedNode1.JPG}
      
A branch is located between two junctions and includes at least one circuit element. 

Citation of images: Electrical4U, "Nodes, Branches, and Loops of a Circuit", 2018. [Online]. Available: https://www.electrical4u.com/nodes-branches-and-loops-of-a-circuit/. [Accessed: January 21, 2019].
